        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rabbits_Breeds_BreedId",
                        column: x => x.BreedId,
                        principalTable: "Breeds",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Rabbits_Cages_CageId",
                        column: x => x.CageId,
                        principalTable: "Cages",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Rabbits_Genders_GenderId",
                        column: x => x.GenderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CageId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MateWith = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateMate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateExpected = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateLittered = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LitterCount = table.Column<int>(type: "int", nullable: false),
                    KittenDeadCount = table.Column<int>(type: "int", nullable: false),
                    BuckCount = table.Column<int>(type: "int", nullable: false),
                    DoeCount = table.Column<int>(type: "int", nullable: false),
                    DateAdded = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Histories_Rabbits_RabbitId",
                        column: x => x.RabbitId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Histories_RabbitId",
                table: "Histories",
                column: "RabbitId");

            migrationBuilder.CreateIndex(
                name: "IX_Rabbits_BreedId",
                table: "Rabbits",
                column: "BreedId");

            migrationBuilder.CreateIndex(
                name: "IX_Rabbits_CageId",
                table: "Rabbits",
                column: "CageId");

            migrationBuilder.CreateIndex(
                name: "IX_Rabbits_GenderId",
                table: "Rabbits",
                column: "GenderId");
        }
